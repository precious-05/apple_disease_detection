...
train_counts = [400, 402, 400, 400]  # From the dataset structure
...
architecture_text = """Base Model: MobileNetV2 (Pre-trained on ImageNet)
...
# 3. Training Performance Curves (Simulated realistic curves)
np.random.seed(42)
